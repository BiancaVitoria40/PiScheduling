...
public class ReservaService {
	...
	public boolean estaCheio(Setores setor, ItemCarrinho itensCarrinho, Ingresso ingresso) {
	...
	public ItemCarrinho adicionaAosMeusIngressos(ItemCarrinho itemCarrinho) {
...
//Cliente cliente = usuarioService.obterUsuarioPorId(itemCarrinho.getCliente().getId());
//
//
//ItemCarrinho novaReserva = new ItemCarrinho();
//Optional<Setores> setor = null;
...
//do {
//
//	optionalIngresso = ingressoService.obterIngressoPorId(ingresso.getId());
//
//	setor = setorService.obetemSetorPorId(optionalIngresso.get().getSetor().getId());
//
//	contador++;
//
//}while(!estaCheio(setor.get(), itemCarrinho, ingresso));
//
//ItemCarrinho reservaExistente = reservaRepository.findByClienteAndIngressos_Id(cliente,
//		optionalIngresso.get().getId());
//
//if (reservaExistente != null) {
//
